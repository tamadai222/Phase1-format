...
const turn = function (e) {
	...
	if (div.innerHTML === "") {
		// => div要素がクリックされた時、innerHTMLが空の時　カードがクローズしていたら
	...
	if (flgFirst) {
		...
		if (cardFirst.number === div.number) {
			//1枚目にクリックされたtargetのnumber === 2枚目のdiv.number
			count++;
